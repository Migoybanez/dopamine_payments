...
def pay_direct():
    ...
    description = "Grab 1,000+ AI MegaPrompts At Only P997 Today! Once you complete payment, you will be led to the link to access our modules + community!"
    data = {
        "data": {
            "attributes": {
...
@app.route("/")
def index():
    return "🚀 Your Flask app is deployed successfully!"
