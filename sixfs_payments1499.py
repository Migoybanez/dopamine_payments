...
@app.route('/pay')
def pay_direct():
    amount = 149900  # ₱1449 in centavos
    ...
    description = "Grab 6-Figure Sprint At Only P1499 Today! Once you complete payment, you will be led to the link to access our modules + community!"
    data = {
        "data": {
            "attributes": {
